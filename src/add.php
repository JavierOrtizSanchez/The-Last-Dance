...
*/		
		mysqli_stmt_bind_param($stmt, "ssisi", $apellido, $nombre, $home_runs, $promedio_bateo , $carreras_impulsadas);
...
?>
	...
	<footer>
    <br>Creado por Javier Ortiz &copy; 2024
  	</footer>
</div>
</body>
</html>
